...
- **Database geometry**: reads nodes, beams, shells, springs and the way they act, couplings, restraints, exact section contours, thicknesses, and element-local axes from `.cdb` databases.
