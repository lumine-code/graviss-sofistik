...
- **Model divisions**: offers the groups an element belongs to, and the geometric axis a member was generated along, as dimensions the viewer can narrow a model by, taking group membership from the element number and the divisor the system record states.
